            ...
            ?>
                  <div class='sec4_top'>
                     <div class='sec4_top_left'>
                        <div class='sec4_top_left_title title'><h2> <?php the_sub_field('sec4_project_name'); ?> </h2></div>
                        <div class='sec4_top_left_text'> <?php the_sub_field('sec4_project_description'); ?> </div>
                     </div>
                     <div class='sec4_top_right'> 
                              <div class='hsec4_slidr_item'style="background-image:url('<?php echo  get_sub_field('sec4_slider_image');?>')"></div>
                              <div class='hsec4_slidr_imgtext' ><?php the_sub_field('sec4_image_description'); ?> </div>
                              <div class='hidden_logo' style='display:none' ><img src="<?php echo  get_sub_field('sec4_slider_logo');?>"/></div>
                             <span class='proj_color' style='display:none'><?php echo  get_sub_field('bg_color');?></span>
                     </div>
                  </div>
                  <?php  endwhile;
                           endif; ?>   
